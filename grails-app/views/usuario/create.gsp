    ...
    <g:hasErrors bean="${this.usuario}">
        <ul class="alert alert-danger" role="alert">
            <g:eachError bean="${this.usuario}" var="error">
                <li class="" <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
            </g:eachError>
        </ul>
    </g:hasErrors>
    <g:form resource="${this.usuario}" class="needs-validation position-relative" method="POST" autocomplete="off">
        <fieldset class="form">
            <f:all bean="usuario" order="username,password,persona"/>
        </fieldset>
        <br>
