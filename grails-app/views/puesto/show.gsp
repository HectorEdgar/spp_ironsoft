...
<div class="col-12">
    ...
    <f:display bean="puesto" />
    <g:form resource="${this.puesto}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="btn btn-info" action="edit" resource="${this.puesto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
