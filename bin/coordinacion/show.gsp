...
<div class="col-12">
    ...
    <f:display bean="coordinacion" />
    <g:form resource="${this.coordinacion}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="btn btn-info" action="edit" resource="${this.coordinacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
